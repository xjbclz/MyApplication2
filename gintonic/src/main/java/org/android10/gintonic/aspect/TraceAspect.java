...
public class TraceAspect {
    ...
    private static final String POINT_METHOD = "execution(* test.ruwant.com.myapplication.MainActivity.on*(..))";
    //private static final String POINT_METHOD = "execution(* android.support.v7.app.AppCompatActivity.findViewById(..))";

    private static final String POINT_CALLMETHOD = "call(* test.ruwant.com.myapplication.MainActivity.on*(..))";
